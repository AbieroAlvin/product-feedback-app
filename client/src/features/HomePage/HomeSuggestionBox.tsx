...
const HomeSuggestionBox = ({ feedback }: { feedback: productType }) => {
  ...
  return (
    ...
    >
      <button
        className={`flex flex-col items-center self-start rounded-[1rem] p-4 transition-all duration-300  disabled:bg-[#ccc] tablet:col-start-1 tablet:row-start-2 tablet:flex-row tablet:gap-3 ${
          isUpvoted
