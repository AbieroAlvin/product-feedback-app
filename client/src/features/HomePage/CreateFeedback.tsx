...
const CreateFeedback = () => {
  ...
  const onSubmit = (data: feedbackState) => {
    createFeedback({
      title: data.title,
      category,
      detail: data.detail,
        ...
        <div className="space-y-[2.4rem] pt-16 tablet:pt-[2.4rem]">
          <div>
            ...
            <input
              type="text"
              id="title"
              className={`w-full rounded-[0.5rem] border border-solid border-transparent bg-[#f7f8fd] px-[2.4rem] py-[1.2rem] text-[1.5rem] text-[#3a4374] outline-transparent tablet:text-[1.3rem] ${
                errors?.title?.message
                  ? "border-[#d73737] focus:border-[#d73737] focus:outline-[#d73737]"
                  : "border-transparent focus:border-[#4661e6] focus:outline-[#4661e6]"
              }`}
              {...register("title", {
          ...
          <div>
            ...
            <textarea
              id="detail"
              rows={4}
              className={`w-full resize-none rounded-[0.5rem] border border-solid border-transparent bg-[#f7f8fd] px-[2.4rem] py-[1.2rem] text-[1.5rem] text-[#3a4374] outline-transparent tablet:text-[1.3rem] ${
