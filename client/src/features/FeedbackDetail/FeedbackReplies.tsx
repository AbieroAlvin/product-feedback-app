      ...
      <div className="grid grid-cols-[auto_1fr_auto] gap-x-[3.2rem] gap-y-[1.7rem] tablet:gap-x-[1.6rem]">
        ...
        {currentUserId === isSameUser ? (
          <div className="flex tablet:relative">
            <div
              className={`flex items-center gap-4 tablet:absolute tablet:left-[-10.5rem] tablet:top-0 tablet:flex-col tablet:items-start tablet:rounded-[1rem] tablet:bg-white tablet:px-12 tablet:py-4 tablet:shadow-modal-sh ${
                openMobileModal ? "tablet:flex" : "tablet:hidden"
              }`}
            >
              <button
